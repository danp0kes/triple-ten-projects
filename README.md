...
| 14 | Computer Vision             |  Good Seed, a supermarket chain wishes to implement a model that ensures alcohol laws are implemented. Cameras will trigger a warning when an underage person may attempt alcohol purchasing.  |   Tensorflow, Deep Learning, Age Detection, Business Optics    | [good-seed](projects/good-seed-cv) |
